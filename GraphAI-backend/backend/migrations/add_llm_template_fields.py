...
执行方式：docker-compose -f docker-compose.backend.yml exec graph-ai-backend python /app/migrations/add_llm_template_fields.py
或者：docker-compose exec graph-ai-backend python /app/migrations/add_llm_template_fields.py
"""
import sys
import os
