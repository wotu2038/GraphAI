...
def generate_requirement_document_task(
    ...
    enable_refine: Optional[bool] = None,
    ...
    try:
        ...
        state: DocumentGenerationState = {
            ...
            "top_k": top_k or retrieval_limit,
            "min_score": min_score or 60.0,
            "enable_refine": enable_refine if enable_refine is not None else True,
